# React webpack starter template with globalization

The aim of this repository is to provide an example for developing Globalized [React](https://facebook.github.io/react/) based applications using ES6 syntax and [webpack](https://webpack.github.io/) as a module bundler.
...
* Run `npm run test:debug` to debug tests in Chrome
